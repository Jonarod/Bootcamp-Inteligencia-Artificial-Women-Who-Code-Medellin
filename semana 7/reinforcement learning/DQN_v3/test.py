...
LOAD_CHECKPOINT 		= True 			# In case you want to save a model file and then train it more later. 
LOAD_FILE 				= './atari_model_PongNoFrameskip-v4_game_350_avg_score_14.8.h5' 	# Filename 
...
INITIAL_EXP 			= 0 			    # Number of random actions to start out with
EPS_MIN 				= 0.0 				# Mimimum chance to take a random action
...
eps 			= 0.0 		# Chance to take a random action
